...
based on the this offical [gitlab document](https://gitlab.com/gitlab-org/gitlab-ce/blob/master/doc/user/markdown.md)
...
The valid video extensions are `.mp4`, `.m4v`, `.mov`, `.webm`, and `.ogv`.
    ...
    ![Sample Video](../../pics/markdown_video.mp4)
...
### Images
    ...
    Inline-style:
    ![alt text](../../pics/markdown_logo.png)

    Reference-style:
    ![alt text1][logo]

    [logo]: ../../pics/markdown_logo.png
